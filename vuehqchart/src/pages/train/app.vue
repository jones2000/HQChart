    ...
    <div id="tools" class="tools">
      <div class="row">
        <div class="col-md-3 col-sm-12 col-xs-12 ">
          <button type="button" class="btn btn-info btn-xs" v-on:click="this.nextKLine()">下一K线</button>
        </div>
        <div class="col-md-5 col-sm-12 col-xs-12">
          <div class="checkbox" style="margin:0px;">
            <label>
              <input type="checkbox" v-model="this.kLineAuto"/> K线自动前进
            </label>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12" style="padding-left:0px;">
          还剩<span style="color:#EE1515;">{{ this.SurplusKLineCount }}</span>根K线
        </div>
      </div>
      <div class="row" style="margin-top:20px;">
        <div class="col-md-6 col-sm-12 col-xs-12">
          <button type="button" class="btn pull-right" v-bind:class="this.buyOrSellState === 0?'btn-danger':'btn-dark'"
                  v-bind:disabled="this.buyOrSellState !== 0" v-on:click="this.buyOrSell()">&nbsp;&nbsp;&nbsp;&nbsp;买&nbsp;&nbsp;&nbsp;&nbsp;
          </button>
        </div>
        <div class="col-md-6 col-sm-12 col-xs-12">
          <button type="button" class="btn" v-bind:class="this.buyOrSellState === 1?'btn-danger':'btn-dark'"
                  v-bind:disabled="this.buyOrSellState !== 1" v-on:click="this.buyOrSell()">&nbsp;&nbsp;&nbsp;&nbsp;卖&nbsp;&nbsp;&nbsp;&nbsp;
          </button>
        </div>
      </div>
      <div class="row">
        <div class="list">
          <table class="table table-striped">
            ...
            <tbody>
            <tr v-for="(item, index) in this.list" v-bind:class="item.profitAndLossClass">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                <label class="control-label col-md-5 col-sm-5 col-xs-12">训练股票：</label>
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <label class="control-label">{{ this.name }}&nbsp;&nbsp;{{ this.symbol }}</label>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <label
                      class="control-label">{{ this.kLineDate.startDate }}&nbsp;&nbsp;至&nbsp;&nbsp;{{ this.kLineDate.endDate }}</label>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-5 col-sm-5 col-xs-12">区间涨幅：</label>
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <label class="control-label" v-bind:class="this.increase > 0?'profit':'loss'">{{ this.increase }}%</label>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-5 col-sm-5 col-xs-12">成功率：</label>
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <label class="control-label">{{ this.profitRatio }}%</label>
                </div>
              </div>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-primary pull-right ladda-button" data-style="expand-right"
                    onclick="this.hideModal('modal_result')">关&nbsp;&nbsp;&nbsp;&nbsp;闭
            </button>
          </div>
        </div>
      </div>
...
import JSNetwork from '../../jscommon/umychart.network'
import GetfloatPrecision from '../../jscommon/umychart'
import ScriptIndexConsole from '../../jscommon/umychart.complier'
import JSIndexScript from '../../jscommon/umychart.index.data'
...
export default {
  ...
  methods: {
    ...
    //老的接口回调目前不用了
    TrainCallback: function (hqchart) {
