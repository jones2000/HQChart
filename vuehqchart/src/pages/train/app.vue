    ...
    <div id="tools" class="tools">
        ...
        <div class="row" style="margin-top:20px;">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <button type="button" class="btn pull-right" v-bind:class="this.buyOrSellState == 0?'btn-danger':'btn-dark'" v-bind:disabled="this.buyOrSellState != 0" v-on:click="this.buyOrSell()">&nbsp;&nbsp;&nbsp;&nbsp;买&nbsp;&nbsp;&nbsp;&nbsp;</button>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
                <button type="button" class="btn" v-bind:class="this.buyOrSellState == 1?'btn-danger':'btn-dark'" v-bind:disabled="this.buyOrSellState != 1" v-on:click="this.buyOrSell()">&nbsp;&nbsp;&nbsp;&nbsp;卖&nbsp;&nbsp;&nbsp;&nbsp;</button>
            </div>
        </div>
        <div class="row">
            <div class="list">
                ...
                <div class="modal-body">
                    <div class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <label class="control-label">{{this.kLineDate.startDate}}&nbsp;&nbsp;至&nbsp;&nbsp;{{this.kLineDate.endDate}}</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-5 col-sm-5 col-xs-12">区间涨幅：</label>
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <label class="control-label" v-bind:class="increase > 0?'profit':'loss'">{{this.increase}}%</label>
                            </div>
                        </div>
                        <div class="form-group">
