...
- **分时图表创建SetOption参数详解**：`references/分时图创建及SetOption参数详解.md`
...
### references/
包含 HQChart 官方参考文档：
- `K线图创建及SetOption参数详解.md` - K线图创建及SetOption参数详解
- `K线图数据格式详解.md` - K线图数据格式详解
- `K线图操作接口函数详情.md` - K线图API接口函数说明
- `K线图配色和样式参数详解.md` - K线图配色、样式参数说明
- `分时图表创建SetOption参数详解.md` -分时图表创建SetOption参数详解
- `分时图数据格式详解.md` - 分时图数据格式详解
