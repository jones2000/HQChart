        ...
        <table>
          <tbody>
            ...
            <tr>
                ...
                <td class="clear"><span class="name">委比</span><span class="flowMarketV">{{StockData.BookRate.Text}}%</span></td>
                <td>量比</td>
            ...
            <tr>
                ...
                <td>换手</td>
                <td><span class="marketV">{{StockData.Excahngerate.Text}}%</span></td>
            </tr>
            <!-- <tr>
                <td>总股本</td>
