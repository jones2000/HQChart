...
JSIndexMap.Get=function(id)
{
    ...
    [
        ...
        ["飞龙四式", {IsMainIndex:true, Create:function(){return new DragonFourIndex}, Name:'飞龙四式'}],
        ...
        ["LON",     {IsMainIndex:false,  Create:function(){ return new LonIndex()},     Name:'钱龙长线'}],
        ["飞龙四式-附图", {IsMainIndex:false,  Create:function(){ return new DragonFourFigureIndex()},     Name:'飞龙四式-附图'}],
